...
Please, close all instances of it and click Retry to continue, or Cancel to exit.</source>
        <translation>Installationsprogrammet för ${PRODUCT_NAME} körs redan.
...
Please, close all instances of it and click Retry to continue, or Cancel to exit.</source>
        <translation>Avinstallationsprogrammet för ${PRODUCT_NAME} körs redan.
Stäng alla instanser av det och klicka Försök igen för att fortsätta, eller Avbryt för att avbryta.</translation>
    </message>
    <message>
...
Do you want to download the installer for the component?</source>
        <translation>Det gick inte att hitta följande obligatoriska komponent på den här datorn:
Visual C++ Runtime ${ARCH}
